        ...
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    ...
                    <input type="checkbox" class="toggle-column" data-column="6"> Name
                    <input type="checkbox" class="toggle-column" data-column="7"> Email
                    <input type="checkbox" class="toggle-column" data-column="8"> Role
                    <!-- Add more toggle buttons for additional columns -->
                </div>
