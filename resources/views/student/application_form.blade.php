...
@section('content')
    ...
    <form class="dataForm" id="regForm" method="POST"
        action="{{ $formRoute ? route($formRoute, ['user' => $user->id]) : route('student.store') }}"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 ">
                        ...
                        <input type="text" class="form-control" id="nom_ar" required="" placeholder="اللقب..."
                            oninput="this.className = ''" name="nom_ar">
                    ...
                    <div class="col-md-6 ">
                        ...
                        <input type="text" class="form-control" id="prenom_ar" required="" placeholder="الاسم..."
                            oninput="this.className = ''" name="prenom_ar">
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 ">
                        ...
                        <input type="text" class="form-control" id="prenom_fr" value="{{ $user->lastname }}" required
                            readonly name="prenom_fr">
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="date_nais" value="{{ $user->birthday }}" required
                            readonly name="date_nais">
            ...
            <label for="note_bac" class="form-label text-md-end"> {{ __('translation.note_bac') }}</label>
                ...
                <input id="note_bac" type="numeric" max="19" class="form-control " name="note_bac" required="" value="" >
                    ...
                    <div class="col-sm-3">
                        ...
                        <select name="city_bac" id="city_bac" required="" value="{{ old('city_bac') }}"
                            class="form-select">
                            <option></option>
        ...
        <div class="tab">
            ...
            <div class="row g-12 p-3">
                ...
                <div class="col-md-9">
                    ...
                    @if ($user->licence_type == 'LMD')
                        <input type="radio" value="Classique" id="Classique" readonly @selected(false)
                            disabled class="form-check-input" name="licence_type">
                        ...
                        <br>
                        <input class="form-check-input" type="radio" name="licence_type" @selected(false)
                            disabled id="ingenieur" value="ingenieur" onclick="afficherCacher()">
                    ...
                    @elseif ($user->licence_type == 'Classique')
                        ...
                        <br>
                        <input class="form-check-input" type="radio" name="licence_type" @selected(false)
                            disabled id="LMD" value="LMD" onclick="afficherCacher()">
                        <label class="form-check-label" for="LMD">
                            {{ __('translation.lmd') }}
                        </label>
                        <br>
                    ...
                    @elseif ($user->licence_type == 'ingenieur')
                        <input type="radio" value="Classique" id="Classique" disabled class="form-check-input"
                            name="licence_type">
                        <label class="form-check-label" for="Classique">
                            {{ __('translation.classique') }}
                        </label>
                        ...
                        <br>
                        <input class="form-check-input" type="radio" name="licence_type" @selected(false)
                            checked id="ingenieur" value="ingenieur" onclick="afficherCacher()">
                        <label class="form-check-label" for="ingenieur">
                            {{ __('translation.ingenieur') }}
                        </label>
                    @endif
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <label for="year_last_dip"
                        class="form-label text-md-end">{{ __('translation.year_last_dip') }}</label>

                    <input id="year_last_dip" type="number" min="1970" max="2024" step="1"
                        value="2022" class="form-control " name="year_last_dip" required="">
            ...
            <div class="row g-3">
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" id="S1" name="S1" class="form-control"
                            max="20" required>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="S2" type="number" step="0.01" class="form-control " name="S2"
                            max="20" required>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="S3" type="number" step="0.01" class="form-control " name="S3"
                            value="" required="">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="S4" type="number" step="0.01" class="form-control " name="S4"
                            value="" required="">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="S5" type="number" step="0.01" class="form-control " name="S5"
                            id="S5" value="">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="S6" type="number" step="0.01" class="form-control " name="S6"
                            id="S6" value="">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="col-md-4">
                        <input id="nb_dette" type="number" min="0" class="form-control " name="nb_dette"
                            value="">
            ...
            <div class="form-group row p-2">
                <div class="alert alert-danger alert-dismissible fade show col-11" role="alert">
                    ...
                    <ul>
                        ...
                        <li>- كشوف النقاط</li>
                        <li>- شهادة حسن السيرة</li>
                        <li>– إثبات الاقامة</li>
                        <li>– شهادة ميلاد حديثة</li>
                    </ul>
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            ...
            <div class="form-group row p-2">
                ...
                <div class="col-md-9">
                    <select name="department_id" id="department_id" class="form-select" required="true">
                        ...
                        <option value="" selected="" required="true">{{ __('translation.select_departement') }}
                        </option>

                        @foreach ($departments as $dep)
                            @if ($dep->is_active)
                                <option value="{{ $dep->id }}"
                                    data-speciality_max_choice="{{ $dep->speciality_max_choice }}">{{ $dep->name_fr }} -
                                    {{ $dep->name_ar }}</option>
                            @endif
                        @endforeach
                    </select>
        ...
        <div class="text-end " style="overflow:auto;padding-left: 15px; padding-right: 15px;">
            <div class="col align-self-end next-prev">
                <button type="button" id="prevBtn"
                    onclick="nextPrev(-1)">&#8810;{{ __('pagination.previous') }}</button>
