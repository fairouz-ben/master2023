	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 ">
			  ...
			  <div class="col-md-6">
				...
				<input type="date" class="form-control  @error('date_nais') is-invalid @enderror" id="date_nais" value="{{$user->birthday}}"  required="" placeholder="00/00/0000" oninput="this.className = ''" name="date_nais">
        ...
        @enderror
			  ...
			  <div class="col-md-6">
				...
				<input type="numeric" class="form-control" id="phone"  required=""  oninput="this.className = ''" name="phone">
				<div class="valid-feedback">
				  Looks good!
				</div>
			  </div>
...
<h2>{{__('translation.info_licence')}}:</h2>
  ...
  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S1" type="numeric" class="form-control " name="S1" max="20" value="" required="">
		  ...
		  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S2" type="numeric" class="form-control " name="S2" value="" max="20" required="">
		  ...
		  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S3" type="numeric" class="form-control " name="S3" value="" required="">
		  ...
		  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S4" type="numeric" class="form-control " name="S4" value="" required="">
		  ...
		  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S5" type="numeric" class="form-control " name="S5" id="S5" value="">
		  ...
		  <div class="col-sm-4">
              ...
              <div class="col-md-4">
                  <input id="S6" type="numeric" class="form-control " name="S6"  id="S6" value="">
